...
class Decena extends StatefulWidget {
  const Decena({super.key});

  static final String routeName = "decena";

  @override
  State<Decena> createState() => _DecenaState();
}
...
class _DecenaState extends State<Decena> {
  @override
      ...
      body: Container(
        child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                " (Ejemplo: Decena 2 es 20,21,22,23,...,29)",
    ...
    return GestureDetector(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                color: selecD == true ? Colors.blue : Colors.white,
              ),
              boxShadow: <BoxShadow>[
                BoxShadow(
  ...
  void _selecBtn(String btn) {
    if (selecD && decena.length < 2) {
      decena = decena + btn;
    } else {
      print("numero supera mas de dos digitos $decena");
    }
  ...
  void _borrar() {
    if (selecD) {
      if (decena.length > 0) {
        decena = decena.substring(0, decena.length - 1);
      } else {
        decena = "";
      }
    }
  ...
  bool habilitarBtn() {
    if ((decena.length != 0 && fijo.length != 0) ||
        (decena.length != 0 && corrido.length != 0)) {
      return true;
    }
    return false;
  }
